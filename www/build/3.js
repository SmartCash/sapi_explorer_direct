...
var SearchPage = /** @class */ (function () {
    ...
    SearchPage = __decorate([
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-search',template:/*ion-inline-start:"C:\Projects\smartcash\explorer\src\pages\search\search.html"*/'<head-nav></head-nav>\n\n\n\n<ion-content class="content-container">\n\n    <ion-grid class="page-content-grid">\n\n        <ion-row *ngIf="matches?.blocks && matches?.blocks.length > 0">\n\n            <ion-col col-12>\n\n                <h2 class="content-container--heading">Blocks:</h2>\n\n            </ion-col>\n\n            <ion-col col-12 class="page-content" *ngFor="let block of matches?.blocks"\n\n                (click)="goToBlock(block)">\n\n                <div ion-item no-lines>\n\n                    <div ion-text color="primary">\n\n                        Block Hash {{ block?.hash }}\n\n                    </div>\n\n                    <div ion-text color="dark-light">Mined on {{ block?.time | date:\'medium\' }}</div>\n\n                </div>\n\n            </ion-col>\n\n        </ion-row>\n\n        <ion-row *ngIf="matches?.txs && matches?.txs.length > 0">\n\n            <ion-col col-12>\n\n                <h2 class="content-container--heading">Transactions:</h2>\n\n            </ion-col>\n\n            <ion-col col-12 class="page-content" *ngFor="let tx of matches?.txs" (click)="goToTx(tx)">\n\n\n\n                <div ion-item no-lines>\n\n                    <div ion-text color="primary">\n\n                        {{ tx?.txid }}\n\n                    </div>\n\n                    <div ion-text color="dark-light">Received Time {{ tx?.blockTime | date:\'medium\' }}</div>\n\n                </div>\n\n            </ion-col>\n\n        </ion-row>\n\n        <ion-row *ngIf="matches?.addresses && matches?.addresses.length > 0">\n\n            <ion-col col-12>\n\n                <h2 class="content-container--heading">Addresses:</h2>\n\n            </ion-col>\n\n            <ion-col col-md-6 col-12 class="page-content" *ngFor="let addr of matches?.addresses"\n\n                (click)="goToAddress(addr)">\n\n\n\n                <div ion-item no-lines>\n\n                    <div ion-text color="primary">\n\n                        {{ addr?.address }}\n\n                    </div>\n\n                </div>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-content>\n\n<footer></footer>\n\n'/*ion-inline-end:"C:\Projects\smartcash\explorer\src\pages\search\search.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]) === "function" ? _a : Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__providers_api_api__["a" /* ApiProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_api_api__["a" /* ApiProvider */]) === "function" ? _b : Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__providers_price_price__["a" /* PriceProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__providers_price_price__["a" /* PriceProvider */]) === "function" ? _c : Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* Events */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* Events */]) === "function" ? _d : Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_3__providers_currency_currency__["a" /* CurrencyProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__providers_currency_currency__["a" /* CurrencyProvider */]) === "function" ? _e : Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_5__providers_redir_redir__["a" /* RedirProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__providers_redir_redir__["a" /* RedirProvider */]) === "function" ? _f : Object])
    ], SearchPage);
    return SearchPage;
}());
